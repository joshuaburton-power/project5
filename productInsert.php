        ...
        <script type='text/javascript'>
            ...
            function doSave()
            {
                ...
                $.ajax({
                    url: 'sqlproduct.php',
                    cache: false,
                    data: {'request': urlRequest, 'barcode': barcode, 'weightKg': weightKg, 'desc': desc, 'productTypeId': productTypeId, 'productid':productId},
                    dataType: 'json',
                    success: function(data)
                    {
                        document.location.href = 'productsMain.php';
        ...
        <form name="productInsert" >
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" name="barcode" id="barcode" value ='<?php echo trim($barcode); ?>' maxlength="13" >
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="desc" name="desc" size='50' value='<?php echo trim($desc); ?>' >
                    </td>
                </tr>
                <tr>
                    <td>
