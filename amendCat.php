        ...
        <script type='text/javascript'>
            ...
            function doSave()
            {
                ...
                $.ajax({
                    url: 'sqlproduct.php',
                    cache: false,
                    data: {'request': urlRequest, 'typeDesc': typeDesc, 'productTypeId': productTypeId},
                    dataType: 'json',
...
?>
        <form name="productInsert" >
            ...
            <input type="hidden" id="productTypeId" value="<?php echo $productTypeId ?>" >
